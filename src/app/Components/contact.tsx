...
function ContactSection() {
  ...
  return (
    <div className="contact-section bg-darkGreen text-white pt-16 pb-8">
      {/* <Toaster /> */}
      <div className="flex flex-col items-center text-center px-4">
        ...
        <div className='pt-5'>
          <a href='https://forms.gle/Ke6qhXuFCbNqxxua7' target="_blank" rel="noopener noreferrer">
            <button className='bg-orange hover:opacity-80 px-6 py-3  md:px-6 lg:px-9 md:py-4 lg:py-5 text-md sm:text-xl md:text-xl lg:text-xl rounded-full font-bold'>Get Your Website Today</button>
          </a>
        </div>

...
function Footer() {
    return (
        <div className="footer bg-darkGreen text-white">
            <div className="md:max-w-[1280px] md:m-auto">
                <div className="flex justify-between items-start px-4 md:px-10 py-10 pt-10 flex-col md:flex-row">
                    <div className="py-4">
                ...
                <div className="md:px-10 px-4 pb-5 flex justify-between items-start flex-col md:flex-row md:items-center">
                    <div className="py-3">
